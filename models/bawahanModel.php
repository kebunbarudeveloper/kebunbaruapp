...
class bawahanModel extends CI_Model
{
    ...
    public function getKategoriJabatan()
    {
        ...
        try {
            $response = $this->_client->request('GET', 'aturjabatan', [
                'query' => [
    ...
    public function getJabatan()
    {
        ...
        try {
            $response = $this->_client->request('GET', 'aturjabatan/getJabatan', [
                'query' => [
                    'KEBUNBARU-KEY' => 'f7f3d294cb068555257017c1dfb0f2',
                    'id' => $kategori,
                    'tipe' => $tipe,
    ...
    public function getIDJabatan()
    {
        ...
        try {
            $response = $this->_client->request('GET', 'aturjabatan/getIDJabatan', [
                'query' => [
                    'KEBUNBARU-KEY' => 'f7f3d294cb068555257017c1dfb0f2',
                    'id' => $kategori,
                    'periode' => $periode,
    ...
    public function TambahJabatan()
    {
        ...
        $data = [
            'urutjabatan' => $this->input->post('urutjabatan', true),
            'kategorijabatan' => $this->input->post('idkategori', true),
            'namajabatan' => ucwords($this->input->post('namajabatan', true)),
            'KEBUNBARU-KEY' => 'f7f3d294cb068555257017c1dfb0f2'
        ];

        $response = $this->_client->request('POST', 'aturjabatan', [
            'form_params' => $data
        ]);
